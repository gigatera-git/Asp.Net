...
<html lang="ko">
      ...
      $(document).ready(function () {
          ...
          */
          ...
          $("#frmBoard").submit(function (e) {
              ...
              if (confirm("저장할까요?")) {
                  //$("#frmBoard").attr({ 'action': 'write_ok.asp' });
              } else {
                  e.preventDefault();
              }
          });
 ...
 <body>
	...
	<form name="frmBoard" id="frmBoard" method="post" enctype="multipart/form-data" runat="server">
		...
		<td><input type="text" name="uname" id="uname" value="이름牧" size="10" maxlength="10" placeholder="글쓴이" autofocus required oninvalid="this.setCustomValidity('글쓴이를 입력하세요')" oninput="setCustomValidity('')"></td>
		</tr>
		<tr>
